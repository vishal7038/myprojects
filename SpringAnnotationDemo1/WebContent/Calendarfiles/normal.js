...
var giDatePos=2;//0	// date format sequence  0: D-M-Y ; 1: M-D-Y; 2: Y-M-D
var gbPadZero=true;	// whether to pad the digits with 0 in the left when less than 10.
var giMonthMode=0;//3	// month format 0: digits ; 1: full name from gMonths; >2: abbreviated month name in specified length.
...
var gcCalBG="#336699";	// 6699cc the MAIN background color of the outer calendar panel.
